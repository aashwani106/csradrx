    ...
    return (
        <section className="relative overflow-hidden px-2 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-20 md:px-8 md:pb-24 md:pt-22 lg:min-h-screen lg:pb-20 lg:pt-20">
            <div className="absolute inset-0 -z-10">
                <Float className="absolute left-[12%] top-[18%] h-40 w-40 rounded-full bg-[color:var(--accent)]/8 blur-3xl" amplitude={10} duration={13} />
                <Float className="absolute right-[14%] top-[24%] h-72 w-72 rounded-full bg-white/[0.03] blur-3xl" amplitude={14} duration={16} />
                <div className="absolute inset-y-0 right-0 hidden w-[58%] lg:block">
                    <Reveal delay={0.35} distance={24} className="h-full w-full">
                    <svg
                        viewBox="0 0 760 700"
            ...
            <div className="mx-auto grid max-w-7xl items-center gap-14 lg:min-h-[78vh] lg:grid-cols-[1.05fr_0.95fr]">
                <div className="text-left">
                    <Reveal
                        className="mb-7 inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.28em] text-zinc-500"
                        distance={20}
                    >
                    ...
                    <Reveal
                        delay={0.08}
                        distance={28}
                        className={`${exo2.className} max-w-4xl text-5xl font-bold leading-[0.92] tracking-[-0.06em] text-white sm:text-6xl md:text-7xl lg:text-[7.25rem]`}
                    >
